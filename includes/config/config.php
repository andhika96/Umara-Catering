<?php
	...
	*/
	...
	$config['sess_cookie_name'] = 'ardev_ucsess';
	...
	*/
	...
	$config['csrf_token_name'] = 'ardev_uc2020';
	$config['csrf_cookie_name'] = 'ardev_ucpitaloka';
	$config['csrf_expire'] = 7200;
	$config['csrf_regenerate'] = TRUE;
	$config['csrf_exclude_uris'] = ['contact_us'];
	...
	*/
	...
	$config['common_function'] = 'function.php';
