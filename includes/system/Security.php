<?php
	 ...
	 *	Information file: Security Class
	 */

defined('BASEPATH') OR exit('No direct script access allowed');

class ARUNA_Security {
	...
	protected $_csrf_token_name = 'ar_csrf_token';
	...
	protected $_csrf_cookie_name = 'ar_csrf_token';
	...
	public function set_csrf($set_active = 0)
	{
		if (empty($set_active) && $set_active == 0)
		{
			return FALSE;
		}
	...
	public function csrf_verify()
	{
		...
		{
			// Remove in version 4.2.3
			// $req_uri = str_replace('p=', '', $_SERVER['QUERY_STRING']);
	 ...
	 * Get CSRF Token Name
	 *
	 * @see		ARUNA_Security::$_csrf_token_name
	 ...
	 *
	 * @used-by	ARUNA_Security::xss_clean()
	 * @param	array	$matches
	 * @return	string
	 */
	 ...
	 *
	 * @used-by	ARUNA_Security::_js_img_removal()
	 * @used-by	ARUNA_Security::_js_link_removal()
	 * @param	string	$str
	 * @return	string
	 */
